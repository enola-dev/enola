...
class ThingRdfConverterInto implements ConverterInto<ThingOrBuilder, RDFHandler> {

    private final ValueFactory vf;

    public ThingRdfConverterInto(ValueFactory vf) {
        this.vf = vf;
    }

    public ThingRdfConverterInto() {
