...
class MemoryResourceTest {
    ...
    @Test
    void testBinaryMemoryResource() throws IOException {
    ...
    @Test
    void testTextMemoryResource() throws IOException {
    ...
    @Test
    void testMediaTypePrecedenceHTML_GZIP() {
    ...
    @Test
    void testMediaTypePrecedenceYAML_JSON() {
