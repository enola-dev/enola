...
public class ExtendedExampleRecordBuilder {
    ...
    @Generated("io.soabase.recordbuilder.core.RecordBuilder")
    private ExtendedExampleRecordBuilder(CustomDatatype customDatatype, BigDecimal bigDecimal,
            URI url, String text, Integer number, Instant instant, Example example,
     ...
     */
    @Generated("io.soabase.recordbuilder.core.RecordBuilder")
    public static ExtendedExampleRecord ExtendedExampleRecord(CustomDatatype customDatatype,
            BigDecimal bigDecimal, URI url, String text, Integer number, Instant instant,
            Example example, List<Example> examplesInOrder, Set<Example> examplesBag,
            Map<String, Example> map) {
        return new ExtendedExampleRecord(customDatatype, bigDecimal, url, text, number, instant, example, examplesInOrder, examplesBag, map);
    }
    ...
    public static ExtendedExampleRecordBuilder builder(ExtendedExampleRecord from) {
        return new ExtendedExampleRecordBuilder(from.customDatatype(), from.bigDecimal(), from.url(), from.text(), from.number(), from.instant(), from.example(), from.examplesInOrder(), from.examplesBag(), from.map());
    }
    ...
    public static Stream<Map.Entry<String, Object>> stream(ExtendedExampleRecord record) {
        return Stream.of(new AbstractMap.SimpleImmutableEntry<>("customDatatype", record.customDatatype()),
    ...
    public String toString() {
        return "ExtendedExampleRecordBuilder[customDatatype=" + customDatatype + ", bigDecimal=" + bigDecimal + ", url=" + url + ", text=" + text + ", number=" + number + ", instant=" + instant + ", example=" + example + ", examplesInOrder=" + examplesInOrder + ", examplesBag=" + examplesBag + ", map=" + map + "]";
    }

    @Generated("io.soabase.recordbuilder.core.RecordBuilder")
    @Override
    public int hashCode() {
        return Objects.hash(customDatatype, bigDecimal, url, text, number, instant, example, examplesInOrder, examplesBag, map);
    }

    @Generated("io.soabase.recordbuilder.core.RecordBuilder")
    @Override
    public boolean equals(Object o) {
        return (this == o) || ((o instanceof ExtendedExampleRecordBuilder r)
    ...
    public interface With {
        ...
        default ExtendedExampleRecordBuilder with() {
            return new ExtendedExampleRecordBuilder(customDatatype(), bigDecimal(), url(), text(), number(), instant(), example(), examplesInOrder(), examplesBag(), map());
        }
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code customDatatype}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code bigDecimal}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code number}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code instant}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code example}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code examplesInOrder}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
        ...
        /**
         * Return a new instance of {@code ExtendedExampleRecord} with a new value for {@code examplesBag}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
