...
public class ExampleRecordBuilder {
    ...
    @Generated("io.soabase.recordbuilder.core.RecordBuilder")
    public static ExampleRecord ExampleRecord(
            String text,
            Integer number,
            Instant instant,
            Example example,
    ...
    public String toString() {
        return "ExampleRecordBuilder[text="
                + text
                + ", number="
                + number
                + ", instant="
    ...
    public boolean equals(Object o) {
        return (this == o)
                || ((o instanceof ExampleRecordBuilder r)
    ...
    public interface With {
        ...
        default ExampleRecord withText(String text) {
            return new ExampleRecord(
                    text, number(), instant(), example(), examplesInOrder(), examplesBag(), map());
        }
        ...
        /**
         * Return a new instance of {@code ExampleRecord} with a new value for {@code
         * examplesInOrder}
         */
        @Generated("io.soabase.recordbuilder.core.RecordBuilder")
