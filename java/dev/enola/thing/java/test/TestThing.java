...
public interface TestThing extends Thing {
    ...
    interface Builder<B extends TestThing> extends Thing.Builder<B> {

        ImmutableTestThing.Builder label(String label);

        ImmutableTestThing.Builder number(Integer number);
    }
}
